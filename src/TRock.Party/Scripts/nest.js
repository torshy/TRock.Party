    ...
    nest.nest = function (api_key, host) {
        ...
        function creator(type, methods) {
            ...
            return function (params) {
                ...
                if (container["id"] != undefined || container["name"] != undefined) {
                //if (this.id != undefined || this.name != undefined || this.name == "") {
        ...
        container.playlist = creator("playlist", ['basic', 'static']);
        container.dynamicPlaylist = creator("playlist/dynamic", ['create', 'restart', 'next', 'feedback', 'steer', 'info']);
        return container;
    };
    return nest;
}());
